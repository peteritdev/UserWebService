...
// Repository
const MenuRepository = require( '../repository/menurepository.js' );
const _menuRepository = new MenuRepository();
...
class MenuService{
    ...
    async getById(pParam){
        ...
        if( xFlagProcess )xJoResult = await _menuRepository.getById(pParam);
    ...
    async list(pParam){
        ...
        var xResultList = await _menuRepository.list(pParam);
    ...
    async save( pParam ){
        ...
        if( xFlagProcess )xJoResult = await _menuRepository.save(pParam, xAct);
    ...
    async delete( pParam ){
        ...
        if( xFlagProcess ){
            var xJoResult = await _menuRepository.delete( pParam );       
        }
