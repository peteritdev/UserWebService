            ...
            if( xData != null ){
                xJoResult = {
                    ...
                    data: {
                        ...
                        application_table: {
                            id: await _utilInstance.encrypt((xData.application_table.id).toString(), config.cryptoKey.hashKey),
                            name: xData.name,
                            table_name: xData.application_table.table_name,
                            application: {
                                id: await _utilInstance.encrypt((xData.application_table.application.id).toString(), config.cryptoKey.hashKey), 
