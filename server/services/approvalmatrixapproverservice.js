            ...
            if( xResultList.count > 0 ){
                ...
                for(var index in xRows){                
                    ...
                    xJoArrData.push({
                        ...
                        approval_matrix: {
                            id: await _utilInstance.encrypt((xRows[index].approval_matrix.id).toString(), config.cryptoKey.hashKey),
                            application_table: {
                                id: await _utilInstance.encrypt((xRows[index].approval_matrix.application_table.id).toString(), config.cryptoKey.hashKey),
                                table_name: xRows[index].approval_matrix.application_table.table_name,
                                application: {
                                    id: await _utilInstance.encrypt((xRows[index].approval_matrix.application_table.application.id).toString(), config.cryptoKey.hashKey), 
