...
module.exports = (app) => {
    ...
    arrValidate = [];
    arrValidate = [
        check("signature").not().isEmpty().withMessage("Parameter signature can not be empty"),
    ];
    app.get(rootAPIPath + 'approval_matrix/document/verify_approval', approvalMatrixDocumentController.approvalMatrixDocument_VerifyApprovalByQRCode);
