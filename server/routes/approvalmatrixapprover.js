...
module.exports = (app) => {
    ...
    app.post( rootAPIPath + 'approval_matrix/approver/save', arrValidate, approvalMatrixApproverController.approvalMatrixApprover_Save );
    ...
    app.get( rootAPIPath + 'approval_matrix/approver/list', arrValidate, approvalMatrixApproverController.approvalMatrixApprover_List );

    // Detail
    arrValidate = [];
    app.get( rootAPIPath + 'approval_matrix/approver/detail', arrValidate, approvalMatrixApproverController.approvalMatrixApprover_GetById );
    ...
    app.delete( rootAPIPath + 'approval_matrix/approver/delete/:id', approvalMatrixApproverController.approvalMatrixApprover_Delete );
