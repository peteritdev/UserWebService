...
const modelSkcpns = require('../models').user_sk_cpns;
                ...
                return modelSkcpns
                    .findOrCreate({
                        ...
                        defaults: {
                            ...
                            nomor_skck: req.body.nomor_skck,
                            tgl_terbit_skck: ( req.body.tanggal_terbit_skck != null && req.body.tanggal_terbit_skck != "" ? req.body.tanggal_terbit_skck : null ),
                        ...
                        if( created ){
                            ...
                            modelSkcpns
                                ...
                                .then(() => {
                                    joResult = JSON.stringify({
                                        "status_code": "00",
                                        "status_msg": "SK-CPNS successfully updated"
                                    });
                                    res.setHeader('Content-Type','application/json');
									res.status(201).send(joResult);
                                })
