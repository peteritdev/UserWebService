//Service
const ApprovalMatrixApproverUserService = require('../services/approvalmatrixapproveruserservice.js');
const _serviceInstance = new ApprovalMatrixApproverUserService();
...
module.exports = {approvalMatrixApproverUser_Save, approvalMatrixApproverUser_List, approvalMatrixApproverUser_Delete};

// Document Type
async function approvalMatrixApproverUser_List( req, res ){
    var joResult;
    var errors = null;
...
async function approvalMatrixApproverUser_Save(req, res){
    var joResult;
    var errors = null;
...
async function approvalMatrixApproverUser_Delete( req, res ){
    var joResult;
    var errors = null;
